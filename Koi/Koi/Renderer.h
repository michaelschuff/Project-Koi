...
//    void DrawLayerQuad(const koi::Vector2f& offset, const koi::Vector2f& scale, const koi::Color tint) override
//    {
//      glBegin(GL_QUADS);
...
//    void DrawDecalQuad(const koi::DecalInstance& decal) override
//    {
